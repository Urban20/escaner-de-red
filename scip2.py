import requests,ipaddress,socket,random,subprocess,threading,pandas,argparse,keyboard
...
args = argparse.ArgumentParser(description='scip2 es una herramienta de reconocimiento de redes con busqueda en shodan y escaneo de redes, entre otras cosas',
    usage='escribir el parametro -h o --help para ver las funciones disponibles')

args.add_argument('-s','--shodan',action=argparse.BooleanOptionalAction,help='busqueda automatica en shodan, si no encuentra nada busca en fofa')
args.add_argument('-n','--normal',action=argparse.BooleanOptionalAction,help='escaneo de puertos con el metodo normal')
args.add_argument('-a','--agresivo',action=argparse.BooleanOptionalAction,help='escaneo agresivo: escanea todos los puertos en simultaneo (puede fallar)')
args.add_argument('-p','--selectivo',type=str,help='para escanear puertos puntuales')
args.add_argument('-ip','--ip',type=str,help='ip objetivo para el ataque')
args.add_argument('-b','--buscar',type=int,help='busqueda de ips, puede utilizarse junto con -g para guardar')
args.add_argument('-g','--guardar',action=argparse.BooleanOptionalAction,help='guardar ips en lista')
...
if param.normal and param.buscar == None:
    if param.ip != None:
