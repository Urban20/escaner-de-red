...
└────────────────────────────────────────────────────────────────────────────┘
    ...
    '''
    h = Fore.WHITE+'''
scip3.0 es una herramienta de reconocimiento de redes desarrollada por Urb@n con busqueda en shodan y escaneo de redes,
entre otras cosas

opciones:
  -h, --ayuda            muestra este mensaje
  -s, --shodan
                        busqueda automatica en shodan, si no encuentra nada busca en fofa
  -n, --normal
                        escaneo de puertos con el metodo normal
  -a, --agresivo
                        escaneo agresivo: escanea todos los puertos en simultaneo (puede fallar)
  -p SELECTIVO, --selectivo SELECTIVO
                        para escanear puertos puntuales
  -ip IP, --ip IP       ip objetivo para el ataque
  -b BUSCAR, --buscar BUSCAR
                        busqueda de ips, puede utilizarse junto con -g para guardar
  -g, --guardar
                        guardar ips en lista
  -i, --info
                        muestra informacion de los encabezados en caso de encontrarse un puerto que apunta a un html
    '''
    print('''
##################################################################################################''')
    print(logo)
...
#################################################''')
        ...
        hilo4 = threading.Thread(target=progreso)
