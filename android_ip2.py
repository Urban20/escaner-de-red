import requests,os,ipaddress,socket,random,threading,time
...
init()
n = 0
android=Fore.GREEN+r'''
                .,.                    .,.                  
                 ':.       ....       ':.                   
                  ':,,:clodddddool:;';:.                    
                .,cdkkkkkkkkkkkkkkkkkkd:'                   
              .:dkkkkkkkkkkkkkkkkkkkkkkkxo,.                
            .;dkkko  dkkkkkkkkkkkkkko  dkkko'               
           .ckkkkx:  lkkkkkkkkkkkkkx: .lkkkkx;              
          .ckkkkkkxddkkkkkkkkkkkkkkkxddkkkkkkx;             
          ;xkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkd'            
         .lkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk;            
  ....    ';,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,.    ...     
.:dxxxl, .:olllllllllllllllllllllllllllllllllll, .;oxxxo,   
:kkkkkkd'.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.;kkkkkkx'  
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
...
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
ckkkkkkx,.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.:kkkkkkx;  
:kkkkkkx'.okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:.;kkkkkkx,  
.cxkkkd; .okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk: .cxkkkd:.  
  .....  .okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:   .....    
         .lkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk:            
          'okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkxl.            
           .';;;:okkkkkkko::;;;cdkkkkkkxl;;;,.              
                 ;kkkkkkk;     .lkkkkkkx'                   
                 :kkkkkkk;     .lkkkkkkx'                   
                 :kkkkkkk;     .lkkkkkkx'                   
                 :kkkkkkk;     .lkkkkkkx'                   
...
descripciones = {
    ...
    22: 'SSH (Secure Shell) – Acceso remoto seguro a través de terminal.',
    23: 'Telnet – Acceso remoto sin cifrar (obsoleto en muchos casos).',
    ...
    67: 'DHCP (Dynamic Host Configuration Protocol) – Asignación de direcciones IP en redes.',
    68: 'DHCP – Respuesta a solicitudes de asignación de direcciones IP.',
    69: 'TFTP (Trivial File Transfer Protocol) – Transferencia de archivos simple.',
    80: 'HTTP (Hypertext Transfer Protocol) – Navegación web sin cifrar.',
    110: 'POP3 (Post Office Protocol v3) – Recepción de correos electrónicos.',
    115: 'SFTP (Simple File Transfer Protocol) – Transferencia simple de archivos (obsoleto).',
    135: 'Microsoft RPC (Remote Procedure Call) – Comunicación entre procesos en redes Windows.',
    137: 'NetBIOS – Uso en redes locales de Windows para compartir archivos.',
    138: 'NetBIOS Datagram Service.',
    139: 'NetBIOS – Uso en redes locales de Windows para compartir archivos.',
    143: 'IMAP (Internet Message Access Protocol) – Recepción de correos con acceso remoto a buzón.',
    161: 'SNMP (Simple Network Management Protocol) – Administración de red.',
    162: 'SNMP Trap – Notificaciones de SNMP.',
    443: 'HTTPS (HTTP Secure) – Navegación web cifrada mediante SSL/TLS.',
    445: 'SMB (Server Message Block) – Protocolo de compartición de archivos en Windows.',
    465: 'SMTPS (SMTP over SSL) – Envío de correos electrónicos cifrados.',
    514: 'Syslog – Envío de logs de sistema a servidores remotos.',
    587: 'SMTP (con STARTTLS) – Envío de correos electrónicos cifrados con seguridad adicional.',
    631: 'IPP (Internet Printing Protocol) – Protocolo de impresión en red.',
    993: 'IMAPS (IMAP over SSL) – IMAP cifrado.',
    995: 'POP3S (POP3 over SSL) – POP3 cifrado.',
    3306: 'MySQL – Conexión a bases de datos MySQL.',
    3389: 'RDP (Remote Desktop Protocol) – Acceso remoto a escritorio de Windows.',
    5432: 'PostgreSQL – Conexión a bases de datos PostgreSQL.',
    5900: 'VNC (Virtual Network Computing) – Acceso remoto a escritorios.',
    6379: 'Redis – Base de datos en memoria de tipo clave-valor.',
    1194: 'OpenVPN – Servicio de VPN seguro.',
    1433: 'Microsoft SQL Server – Base de datos SQL de Microsoft.',
    1434: 'Microsoft SQL Monitor – Monitoreo de SQL Server.',
    1521: 'Oracle DB – Conexión a bases de datos Oracle.',
    1723: 'PPTP (Point-to-Point Tunneling Protocol) – VPN menos segura.',
    2049: 'NFS (Network File System) – Protocolo de compartición de archivos en sistemas Unix/Linux.',
    2082: 'cPanel (no cifrado) – Acceso al panel de control web cPanel.',
    2083: 'cPanel (cifrado) – cPanel con cifrado SSL.',
    8080: 'HTTP alternativo – Utilizado a veces como alternativo para HTTP.',
    8443: 'HTTPS alternativo – HTTPS alternativo utilizado por algunos servidores y aplicaciones.',
    8888: 'HTTP alternativo – Otro puerto común para aplicaciones web.',
    7547: 'TR-069 – Gestión remota de dispositivos como routers.',
    119: 'NNTP (Network News Transfer Protocol) – Transferencia de artículos de noticias Usenet.',
    515: 'LPD (Line Printer Daemon) – Servicio de impresión en red.',
    6667: 'IRC (Internet Relay Chat) – Comunicación en tiempo real mediante chat.'
}
...
def puertos_scan(ip):
    try:
        ...
        #si no se le inserta el argumento p
        if not 'p' in ip:
            ...
            for x in puertos:
                ...
                try:
                    ...
                    s.close()
        #si se le inserta el argumento p 
        else:
            print(Fore.MAGENTA+f"escaneando puertos TCP de la ip: {ip.split('p')[0]}")
            ...
            for x in eleccion:
                ...
                try:
                    ...
                    print(Fore.RED+f'tiempo agotado para el puerto: {x}')
                    continue
                except PermissionError:
                    print(Fore.RED+f'sin permisos para escanear el puerto: {x}')
        ...
        print(Fore.RED+'caracteres invalidos')
...
def scan_agresivo(ip,puerto):
    ...
    try:  
        ...
        try:
            ...
            print(f'uso mas comun: {descripciones[puerto]}')
...
if __name__ == '__main__':
    ...
    while True:
            ...
            if comando == 'cls':
                ...
                if '-a' in comando[4:]:
                    for x in puertos:
                        hilo = threading.Thread(target=scan_agresivo,args=(comando[4:].split('-')[0],x))
                        hilo.start()
                else:
                    
                    puertos_scan(comando[4:].strip())
                time.sleep(2)
                continue
            else:
                try:
